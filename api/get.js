...
const apiUrl9 = `https://service.pdok.nl/cbs/postcode6/2024/wfs/v1_0?service=WFS&version=2.0.0&request=GetFeature&typeNames=postcode6&outputFormat=application/json&propertyName=gemiddeldeHuishoudensgrootte&srsName=EPSG:28992&&bbox=${target3}`;    const fetchWithErrorHandling = async (url, options = {}) => {
      try {
